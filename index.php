...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="wrapper">
      ...
      <h2 class="writings">Choose the model that you want buy</h2>
      ...
      <!-- next things to do:
        create a credit php system so you can buy your car with your database values
        create a system to calculate the tax of the product that you want to buy
      -->
